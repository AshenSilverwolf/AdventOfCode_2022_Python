...
def divideMod(monkeys_list):

    modValue = 1
    allDivs = [monkey.div_by for monkey in monkeys_list]
...
def play_game(monkeys_list):
    ...
    notable_rounds = [1, 20] + [i*1000 for i in range(1, 11)]

    modValue = divideMod(monkeys_list)
